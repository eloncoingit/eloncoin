...
bech32_templates = [
  ...
  ('elc',   0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('elc',   0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('elc',   1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('telc',  0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('telc',  0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('telc',  2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('relc',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('relc',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('relc', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tc',    0, 20, False, False, False),
  ('telc',  17, 32, False, False, False),
  ('relc',  3,  1, False, False, False),
  ('elc',   15, 41, False, False, False),
  ('telc',  0, 16, False, False, False),
  ('relc',  0, 32, True,  False, False),
  ('elc',   0, 16, True,  False, False),
  ('telc',  0, 32, False, True,  False),
  ('relc',  0, 20, False, False, True)
]
