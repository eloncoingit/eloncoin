# Support for Output Descriptors in Eloncoin Core

Since Eloncoin Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `elc1...` for mainnet or `telc1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
on Eloncoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Eloncoin Core wallets, a convenience function `combo` is
