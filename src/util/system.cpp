...
const char * const BITCOIN_CONF_FILENAME = "eloncoin.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Eloncoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Eloncoin";
#else
    // Unix
    return pathRet / ".eloncoin";
#endif
#endif
}
