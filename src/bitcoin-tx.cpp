...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " eloncoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  eloncoin-tx [options] <hex-tx> [commands]  Update hex-encoded eloncoin transaction\n" +
            "or:     eloncoin-tx [options] -create [commands]   Create hex-encoded eloncoin transaction\n" +
            "\n";
