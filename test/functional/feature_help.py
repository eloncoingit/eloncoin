...
"""Verify that starting eloncoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start eloncoin with -h for help text")
        ...
        self.log.info("Start eloncoin with -version for version information")
        ...
        self.log.info("Start eloncoind with -fakearg to make sure it does not start")
